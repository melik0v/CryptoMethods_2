from md5_functions import MD5
from md5_ui import Ui_MainWindow
...
class Make(QMainWindow, Ui_MainWindow):
    ...
    def __hash_btn_clicked(self):
        if not self.input_file_path:
            ...
            self.lineEdit.setText(str(MD5(data, mode="text").generate_hash()))
        else:
            data = self.input_file_path
            self.lineEdit.setText(str(MD5(data, mode="file").generate_hash()))
