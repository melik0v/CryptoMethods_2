from sha1_functions import SHA1
from sha1_ui import Ui_MainWindow
...
class Make(QMainWindow, Ui_MainWindow):
    ...
    def __hash_btn_clicked(self):
        if not self.input_file_path:
            ...
            self.lineEdit.setText(str(SHA1(data, mode="text").generate_hash()))
        else:
            data = self.input_file_path
            self.lineEdit.setText(str(SHA1(data, mode="file").generate_hash()))
